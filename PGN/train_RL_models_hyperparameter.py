...
def estimate_and_update(generator, predictor, prop_to_optimize, n_to_generate, gen_data, **kwargs):
    ...
    return valid_smiles, prediction, form_e_prediction
...
def get_reward_max(compound, predictor, prop_to_optimize, weight, invalid_reward=-1, get_features=get_fp):
    assert prop_to_optimize in ['form_e', 'bulk_mod', 'shear_mod', 'band_gap', 'sinter_temp', 'calcine_temp']
    ...
    if prop_to_optimize == 'form_e':
        try:
            ...
            return weight*form_e + (1-weight)*elec_charge_reward
        except:
        ...
        try:
            ...
            return weight*bulk_mod + (1-weight)*elec_charge_reward
        except:
            return invalid_reward
    elif prop_to_optimize == 'shear_mod':
        try:
            ...
            return weight*shear_mod + (1-weight)*elec_charge_reward
        except:
            return invalid_reward
    elif prop_to_optimize == 'band_gap':
        try:
            ...
            return weight*band_gap + (1-weight)*elec_charge_reward
        except:
            return invalid_reward
    elif prop_to_optimize == 'sinter_temp':
        try:
            ...
            return weight*sinter_temp + (1-weight)*elec_charge_reward
        except: 
            return invalid_reward
    elif prop_to_optimize == 'calcine_temp':
        try:
            ...
            return weight*calcine_temp + (1-weight)*elec_charge_reward
        except: 
            return invalid_reward
...
def train_model(prop_to_optimize, weight, directory):
    ...
    if not os.path.exists(f'/home/ReLeaSE/checkpoints/paper/{directory}/{prop_to_optimize}'):
        os.makedirs(f'/home/ReLeaSE/checkpoints/paper/{directory}/{prop_to_optimize}')
    if not os.path.exists(f'/home/ReLeaSE/checkpoints/paper/{directory}/{prop_to_optimize}/{str(weight)}'):
        os.makedirs(f'/home/ReLeaSE/checkpoints/paper/{directory}/{prop_to_optimize}/{str(weight)}')
    if not os.path.exists(f'/home/jupyter/CJK/RL/paper/data/{directory}'):
        os.makedirs(f'/home/jupyter/CJK/RL/paper/data/{directory}')
    if not os.path.exists(f'/home/jupyter/CJK/RL/paper/data/{directory}/{prop_to_optimize}'):
        os.makedirs(f'/home/jupyter/CJK/RL/paper/data/{directory}/{prop_to_optimize}')
    if not os.path.exists(f'/home/jupyter/CJK/RL/paper/data/{directory}/{prop_to_optimize}/{str(weight)}'):
        os.makedirs(f'/home/jupyter/CJK/RL/paper/data/{directory}/{prop_to_optimize}/{str(weight)}')
    if not os.path.exists(f'/home/jupyter/CJK/RL/paper/data/{directory}/{prop_to_optimize}/{str(weight)}/compounds'):
        os.makedirs(f'/home/jupyter/CJK/RL/paper/data/{directory}/{prop_to_optimize}/{str(weight)}/compounds')
    ...
    for i in range(1, n_iterations+1):
        ...
        if i == 1 or i % 20 == 0:
            if i == 500 or i == 1000:
                curr_path = f'/home/ReLeaSE/checkpoints/paper/{directory}/{prop_to_optimize}/{str(weight)}/biased_{i}'
                my_generator_max.save_model(curr_path)
            final_compounds, property_trained, form_e_trained = estimate_and_update(RL_max.generator, my_predictor, prop_to_optimize=prop_to_optimize, n_to_generate=1000, gen_data=gen_data)
            # save statistics
...
#             with open(f'/home/jupyter/CJK/RL/paper/data/{directory}/{prop_to_optimize}/{str(weight)}/compounds/biased_{i}_generated_compounds.pkl', 'wb') as f:
#                 pickle.dump(final_compounds, f)
            ...
            with open(f'/home/jupyter/CJK/RL/paper/data/{directory}/{prop_to_optimize}/{str(weight)}/compounds/biased_{i}_generated_compound_dict.pkl', 'wb') as f:
            ...
            with open(f'/home/jupyter/CJK/RL/paper/data/{directory}/{prop_to_optimize}/{str(weight)}/biased_{i}_results.pkl', 'wb') as f:
